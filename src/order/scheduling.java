...
public class scheduling {
	...
	int arrti[],burti[],priority[],tim,n;float outfc,outsjf,outsrtf,outpreprio,outnprio,outround;
	float outs[];
	...
	private void initialize() {
		...
		txtAverageWaitingTime.setBackground(new Color(204, 255, 204));
		...
		//btnFcfs.setBackground(new Color(153, 204, 153));
		...
		btnSjf.setBackground(new Color(204, 255, 153));
		...
		btnSrtf.setBackground(new Color(204, 255, 153));
		...
		btnPriorityPre.setBackground(new Color(204, 255, 153));
		...
		btnPriorityNonpre.setBackground(new Color(204, 255, 153));
		...
		btnRoundrobin.setBackground(new Color(204, 255, 153));
		...
		txtNoprocesses_1.setBackground(new Color(204, 255, 204));
		...
		btnGraph.setBackground(new Color(204, 204, 153));
